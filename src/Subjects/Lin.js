...
import L from "./img/Logos/mathematics.png";
import { useState } from "react";
import YouTubeResource from "./Youtube";
import SpotlightCard from "../Animation/SpotlightCard";
import { Link } from "react-router-dom";
import all from "./img/Softians IT Community/2) Softians IT - اجباري تخصص/15.png";
        ...
        <main id="content" style={pageStyles.main}>
          ...
          >
            <PreviewCard
              title="Book"
              name="Linear Book"
              link="https://drive.google.com/file/d/1_XM-lwcYAUhDO46lOMKpZzVzgDDpjOkg/view?usp=drive_link"
            />
          </div>
          ...
          >
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Ahmad Hajjaj"
                embedUrl="https://www.youtube.com/embed/1RnKXrJwseo?si=6d1dAso3GmYbVxb_"
            ...
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Anas Abu-Zahra"
                embedUrl="https://www.youtube.com/embed/LSOObL2qTxY?si=NqdemlaPiyDp4Ymc"
                style={{ width: "100%", height: "100%" }}
              />
            </div>
            ...
            >
              <PreviewCard
                style={{ width: "100%", height: "100%" }}
                title="Dr.Abdullah Shehadeh"
                name="Linear Explain"
                link=" https://drive.google.com/drive/folders/116H-ib8d5OZb7k3azJaiNHrrp2Yxd89D
            "
              />
            </div>
          </div>
          ...
          >
            ...
            <a
              href="https://chat.whatsapp.com/LLeGtCT0h1pEbywNB3CCPK?mode=ems_copy_t"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-block",
