...
import L from "./img/Logos/prototype.png";
import { useState } from "react";
import YouTubeResource from "./Youtube";
import SpotlightCard from "../Animation/SpotlightCard";
import { Link } from "react-router-dom";
import all from "./img/Softians IT Community/3) Softians IT - اختياري تخصص/40.png";
...
export default function Spi() {
  ...
  const lectures = [
    {
      title: "Lecture 1",
      link: "https://drive.google.com/file/d/1Tr0Hm_8Z0Tk4EqGTIqcfTQH1CyXsVp8r/view?usp=drive_link",
      name: "Intro",
    },
    {
      title: "Lecture 2",
      link: "https://drive.google.com/file/d/1X5lrrpYB3GkB5nZLQD_uoPU2NDVDEiSh/view?usp=drive_link",
      name: "Process Model",
    },
    {
      title: "Lecture 3",
      link: "https://drive.google.com/file/d/1egRlxcsgv9r88VHF21RI3FYEB9NYy9_u/view?usp=drive_link",
      name: "Descriptive",
    },
    {
      title: "Lecture 4",
      link: "https://drive.google.com/file/d/1t0j5I6NqdSYN8EDU0tcvWEQuQaPbUN-A/view?usp=drive_link",
      name: "Process Notation",
    },
    {
      title: "Lecture 5",
      link: "https://drive.google.com/file/d/16S41U-CIWIjR2H2pid2ztiJE1Lue8gJd/view?usp=drive_link",
      name: "Process Improvment",
    },
    {
      title: "Lecture 6",
      link: "https://drive.google.com/file/d/1VupzyuhY6ugW4TE0uU_pk0JdhGxrkOZs/view?usp=drive_link",
      name: "CMMI",
    },
  ];
        ...
        <main id="content" style={pageStyles.main}>
          ...
          >
            <PreviewCard
              title="Spi"
              name="Syllabus"
              link="https://drive.google.com/file/d/17_03pijWD10xKp4oYO5_Hy_kj1J1pFuQ/view?usp=drive_link"
            />
          </div>
          <h1 style={{ textAlign: "center", width: "100%", padding: "0 10px" }}>
            Chapters
          ...
          >
            ...
            <a
              href="https://chat.whatsapp.com/IU4rqEARtYy9GgzgORog16?mode=ems_copy_t"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-block",
