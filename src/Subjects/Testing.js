...
import L from "./img/Logos/software.png";
import { useState } from "react";
import YouTubeResource from "./Youtube";
import SpotlightCard from "../Animation/SpotlightCard";
import { Link } from "react-router-dom";
import all from "./img/Softians IT Community/2) Softians IT - اجباري تخصص/32.png";
import "./general.css";
export default function Testing() {
  ...
  const lectures = [
    {
      title: "Lecture 1",
      link: "https://drive.google.com/file/d/1_3MRF7vYojc7Qk8NkgFcqLlqLFbVe44K/view?usp=drive_link",
      name: "Intro",
    },
    {
      title: "Lecture 2",
      link: "https://drive.google.com/file/d/1QN4qahBKM9UOt01DNdCvM1ldvh-DRHDi/view?usp=drive_link",
      name: "Theory",
    },
    {
      title: "Lecture 3",
      link: "https://drive.google.com/file/d/1fALVVN4nDZQ05VBdQWdWYozVmW_ks2LV/view?usp=drive_link",
      name: "Junit",
    },
    {
      title: "Lecture 4",
      link: "https://drive.google.com/file/d/1vw7bXgBRSquEwYIVNDDax32GsC7qXCEr/view?usp=drive_link",
      name: "Agile Testing",
    },
    {
      title: "Lecture 5",
      link: "https://drive.google.com/file/d/12L4A0F_FSqvIZaxxF_tIcL1fH1SEQ2YC/view?usp=drive_link",
      name: "Input Part",
    },
    {
      title: "Lecture 6",
      link: "https://drive.google.com/file/d/1FrWQAndIECFOx9gnAU4nDqxgjNKH_iM0/view?usp=drive_link",
      name: "Logic Testing",
    },
    {
      title: "Lecture 7",
      link: "https://drive.google.com/file/d/1mC3psthtdJBAwaUnqbww-a0yUMQRkBsg/view?usp=drive_link",
      name: "Graphs",
    },
    {
      title: "Lecture 8",
      link: "https://drive.google.com/file/d/16tVnKRHkUlnxRPemnngvJdbTgVPw3MBC/view?usp=drive_link",
      name: "Junit Coverage",
    },
    {
      title: "Lecture 9",
      link: "https://drive.google.com/file/d/1S5pNQrdsvEdrSbtZadW5t2unj3PxLVb8/view?usp=drive_link",
      name: "Graph Coverage",
    },
    {
      title: "Lecture 10",
      link: "https://drive.google.com/file/d/13QYBms1y5y-biL8ZC4HpcEm681guKUdI/view?usp=drive_link",
      name: "Data Flow",
    },
  ];
      ...
      <div id="container" style={pageStyles.container}>
        ...
        <main id="content" style={pageStyles.main}>
          ...
          >
            <PreviewCard
              title="Testing"
              link="https://drive.google.com/file/d/1prhK1ShINk5ILzMhTA79xY8h4aU-g_rd/view?usp=drive_link"
              name="Book"
            />
          </div>
          ...
          >
            <PreviewCard
              title="Syllabus"
              link="https://drive.google.com/file/d/1KfdMmAvHsncomOQV61cv3M9KLYFCK36C/view?usp=drive_link"
              name="Testing"
            />
          </div>
          ...
          >
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Dr.Bashar Al-Shboul"
                embedUrl="https://www.youtube.com/embed/yaCv52M9QlA?si=BmMNY9wPYEAwMsoH"
          ...
          >
            ...
            <a
              href="https://chat.whatsapp.com/FBRxtxZLH5wJrpnlJQ9cJa?mode=ems_copy_t"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "inline-block",
