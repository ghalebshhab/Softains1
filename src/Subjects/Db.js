...
import all from "./img/Softians IT Community/2) Softians IT - اجباري تخصص/17.png";
import L from "./img/Logos/database-file.png";
        ...
        <main id="content" style={pageStyles.main}>
          ...
          >
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Dr.Fairouz"
                embedUrl="https://www.youtube.com/embed/kdd8t9DAw2s?si=Fw8Zr-kn2qjzJCTg"
            ...
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Dr.Subhieh"
                embedUrl="https://www.youtube.com/embed/4brLHWE5Fxg?si=h1qXnudYawE1p7zy"
                style={{ width: "100%", height: "100%" }}
              />
            </div>
            <div style={{ width: "100%", maxWidth: 900, aspectRatio: "16/9" }}>
              <YouTubeResource
                title="Dr.Majdi"
                embedUrl="https://www.youtube.com/embed/XaivuAs396A?si=Aqctg9wuc-z6p9IW"
                style={{ width: "100%", height: "100%" }}
              />
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <a
                  href="https://chat.whatsapp.com/GIwIY6pVO9i1dDVaVeUzp7?mode=ems_copy_t"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    display: "inline-block",
